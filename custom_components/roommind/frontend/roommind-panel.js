...
`,wt=`M11.83,9L15,12.16C15,12.11 15,12.05 15,12A3,3 0 0,0 12,9C11.94,9 11.89,9 11.83,9M7.53,9.8L9.08,11.35C9.03,11.56 9,11.77 9,12A3,3 0 0,0 12,15C12.22,15 12.44,14.97 12.65,14.92L14.2,16.47C13.53,16.8 12.79,17 12,17A5,5 0 0,1 7,12C7,11.21 7.2,10.47 7.53,9.8M2,4.27L4.28,6.55L4.73,7C3.08,8.3 1.78,10 1,12C2.73,16.39 7,19.5 12,19.5C13.55,19.5 15.03,19.2 16.38,18.66L16.81,19.08L19.73,22L21,20.73L3.27,3M12,7A5,5 0 0,1 17,12C17,12.64 16.87,13.26 16.64,13.82L19.57,16.75C21.07,15.5 22.27,13.86 23,12C21.27,7.61 17,4.5 12,4.5C10.6,4.5 9.26,4.75 8,5.2L10.17,7.35C10.74,7.13 11.35,7 12,7Z`;function Tt(e){return e.config?.unit_system?.temperature===`°F`}function w(e){return Tt(e)?`°F`:`°C`}function T(e,t){return Tt(t)?e*9/5+32:e}function E(e,t){return Tt(t)?(e-32)*5/9:e}function D(e,t){return Tt(t)?e*9/5:e}function O(e,t,n=1){return T(e,t).toFixed(n)}function k(e){return Tt(e)?`1`:`0.5`}function A(e,t,n){return{min:String(Math.round(T(e,n))),max:String(Math.round(T(t,n)))}}function Et(e,t){let n=Number(e);if(!Number.isFinite(n))return!1;let r=E(n,t);return r>=5&&r<=35}function j(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var M=t((()=>{}));v(),M();var N=class extends _{constructor(...e){super(...e),this.config=null,this.climateEntityCount=0,this.tempSensorCount=0,this.controlMode=`bangbang`,this.climateControlActive=!0,this.reordering=!1,this.canMoveUp=!1,this.canMoveDown=!1}static{this.styles=[Ct,l`
  ...
  `}render(){return h`
    ...
    `]}disconnectedCallback(){super.disconnectedCallback(),this._clearCountdownTimer()}updated(e){(e.has(`overrideInfo`)||e.has(`config`))&&this._updateCountdown()}_clearCountdownTimer(){this._countdownTimer&&=(clearInterval(this._countdownTimer),void 0)}_getOverrideUntil(){return this.overrideInfo?.active?this.overrideInfo.until:null}_updateCountdown(){if(this._clearCountdownTimer(),!this._getOverrideUntil()){let e=this._getEffectiveOverride();this._countdown=e?C(`hero.permanent`,this.hass?.language??`en`):``;return}let e=()=>{let e=this._getOverrideUntil();if(!e){this._countdown=``,this._clearCountdownTimer();return}let t=e-Date.now()/1e3;if(t<=0){this._countdown=``,this._clearCountdownTimer();return}let n=Math.floor(t/3600),r=Math.floor(t%3600/60);this._countdown=n>0?`${n}h ${r}m`:`${r}m`};e(),this._countdownTimer=setInterval(e,3e4)}_getEffectiveOverride(){return this.overrideInfo?.active?this.overrideInfo:null}_coilDryMinutesLeft(e){return e==null?1:Math.max(1,Math.ceil((e*1e3-Date.now())/6e4))}_renderTargetSection(e){let t=e.target_temp,n=this.hass?.language??`en`,r=this._getEffectiveOverride();if(r){let e=r.type===`boost`?`mdi:fire`:r.type===`eco`?`mdi:leaf`:`mdi:thermometer`,i=r.type===`boost`?C(`override.comfort`,n):r.type===`eco`?C(`override.eco`,n):C(`override.custom`,n),a=`override-${r.type}`,o=r.heat,s=r.cool,c=o!=null&&s!=null&&o!==s,l=o??s??t;return h`
      ...
      <ha-card>
        ...
        ${e?h`
              ...
              ${e.coil_dry_active&&!this.isOutdoor?h`<div class="hero-metric info">
                    <ha-icon icon="mdi:air-filter"></ha-icon>
                    ${C(e.coil_dry_phase===`drain`?`hero.coil_dry_drain`:`hero.coil_dry`,this.hass?.language??`en`,{minutes:this._coilDryMinutesLeft(e.coil_dry_until)})}
                    <rs-info-icon
                      icon="mdi:information-outline"
                      .text=${C(`hero.coil_dry_info`,this.hass?.language??`en`)}
                    ></rs-info-icon>
                  </div>`:g}
    ...
    `}};j([b({attribute:!1})],F.prototype,`hass`,void 0),j([b({attribute:!1})],F.prototype,`area`,void 0),j([b({attribute:!1})],F.prototype,`config`,void 0),j([b({type:Boolean})],F.prototype,`climateControlActive`,void 0),j([b({type:Boolean})],F.prototype,`isOutdoor`,void 0),j([b({attribute:!1})],F.prototype,`overrideInfo`,void 0),j([x()],F.prototype,`_countdown`,void 0),j([x()],F.prototype,`_editingName`,void 0),j([x()],F.prototype,`_nameInput`,void 0),j([x()],F.prototype,`_controlModeInfoExpanded`,void 0),F=j([y(`rs-hero-status`)],F),v(),S(),M();var Pt=class extends _{constructor(...e){super(...e),this.climateMode=`auto`,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){let e=this.language;return h`
    ...
    `}_onModeClick(e){this.dispatchEvent(new CustomEvent(`mode-changed`,{detail:{mode:e},bubbles:!0,composed:!0}))}};j([b({type:String})],Pt.prototype,`climateMode`,void 0),j([b({type:String})],Pt.prototype,`language`,void 0),Pt=j([y(`rs-climate-mode-selector`)],Pt);function I(e){return e.detail?.value??e.target.value??``}function L(e,t){e.dispatchEvent(new CustomEvent(`save-status`,{detail:{status:t},bubbles:!0,composed:!0}))}function Ft(e,t){e.dispatchEvent(new CustomEvent(`hass-more-info`,{bubbles:!0,composed:!0,detail:{entityId:t}}))}v(),S(),M();var It=class e extends _{constructor(...e){super(...e),this.activeIndex=-1,this.selectorEntity=``,this.editing=!1}static{this.sharedStyles=l`
    :host {
      display: block;
    }
...
`;v(),S(),M();var Lt=[`monday`,`tuesday`,`wednesday`,`thursday`,`friday`,`saturday`,`sunday`],z=class extends It{constructor(...e){super(...e),this.schedules=[],this.comfortHeat=21,this.comfortCool=24,this.ecoHeat=17,this.ecoCool=27,this.climateMode=`auto`,this.scheduleTempWarnings=[]}set scheduleSelectorEntity(e){this.selectorEntity=e}get scheduleSelectorEntity(){return this.selectorEntity}set activeScheduleIndex(e){this.activeIndex=e}get activeScheduleIndex(){return this.activeIndex}static{this.styles=[It.sharedStyles,R,l`
      ...
      ${this.schedules.length>0?h`
            <div class="schedule-list">
              ${this.schedules.map((e,n)=>{let r=this._getScheduleState(n,this.schedules.length);return h`
                  ...
                  ${this._renderRejectedTempWarning(r)}
                `})}
            </div>
    ...
    `}_renderRejectedTempWarning(e){if(e!==`active`)return g;let t=this.scheduleTempWarnings??[];if(t.length===0)return g;let n=A(5,35,this.hass);return h`
...
`;v(),S(),M();var Vt=class extends _{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
  ...
  `}render(){return h`
    ...
    `]}render(){return this.editing?this._renderEditMode():this._renderViewMode()}_renderViewMode(){let e=this._selectedThermostats.size>0||this._selectedCoolingDevices.size>0;return h`
      ...
      ${this._heatingSystemType?h`
          ...
          `:g}
    `}_renderViewRow(e,t){let n=this.hass.states[e],r=n?.attributes?.friendly_name||e,i=n?.state,a=n?.attributes??{},o=``;if(t===`climate`){let e=a.current_temperature;e!=null&&(o=`${e.toFixed(1)}${w(this.hass)}`)}else if(t===`temp`){let t=e.startsWith(`climate.`)?a.current_temperature:i;t!=null&&t!==``&&t!==`unknown`&&t!==`unavailable`&&(o=`${Number(t).toFixed(1)}${w(this.hass)}`)}else i&&i!==`unknown`&&i!==`unavailable`&&(o=`${Math.round(Number(i))}%`);let s=t===`climate`&&this.valveProtectionEnabled&&this.valveProtectionExclude.has(e),c=t===`climate`?this.devices.find(t=>t.entity_id===e):void 0,l=c?.idle_action===`fan_only`||c?.idle_action===`setback`||c?.idle_action===`low`,u=c?.setpoint_mode===`follow`&&!!this.selectedTempSensor,d=c?.setpoint_mode===`direct`&&!!this.selectedTempSensor;return h`
      <div class="view-row">
        ...
        ${u?h`<span class="valve-exclude-badge">
              ${C(`devices.setpoint_mode_follow`,this.hass.language)}
            </span>`:g}
        ${d?h`<span class="valve-exclude-badge">
        ...
        <div class="master-info">
          ...
          <div class="master-meta">
            ...
            ${s?.idle_action&&s.idle_action!==`off`?h`<span class="meta-pill"
                ...
                >`:g}
            ${r&&(s?.coil_dry===`on`||s?.coil_dry!==`off`&&this.coilDryEnabledGlobal)?h`<span class="meta-pill"
                  >${C(`devices.coil_dry_summary`,this.hass.language)}</span
                >`:g}
            ${s?.setpoint_mode===`follow`&&this.selectedTempSensor?h`<span class="meta-pill"
                  >${C(`devices.setpoint_mode_follow`,this.hass.language)}</span
                >`:g}
            ...
            <div class="detail-field">
              ...
              >
                <ha-list-item value="inherit"
                  >${C(`devices.coil_dry_inherit`,c)}</ha-list-item
                >
                <ha-list-item value="on">${C(`devices.coil_dry_on`,c)}</ha-list-item>
                <ha-list-item value="off">${C(`devices.coil_dry_off`,c)}</ha-list-item>
              </ha-select>
            </div>

            ${(t.coil_dry??`inherit`)===`inherit`&&!this.coilDryEnabledGlobal?h`
                  <div class="boost-hint">
                    <ha-icon icon="mdi:information-outline"></ha-icon>
                    <span>${C(`devices.coil_dry_global_off_hint`,c)}</span>
                  </div>
                `:g}
            ${(t.coil_dry??`inherit`)===`off`?g:h`
                  <div class="detail-field">
                    <ha-textfield
                      .value=${String(t.coil_dry_minutes??0)}
                      .label=${C(`devices.coil_dry_minutes`,c,{minutes:this.coilDryMinutesGlobal})}
                      type="number"
                      step="1"
                      min="0"
                      max="60"
                      @change=${t=>{let n=parseInt(t.target.value,10);!isNaN(n)&&n>=0&&n<=60&&this._onCoilDryMinutesChange(e,n)}}
                    ></ha-textfield>
                  </div>
                  ...
                  <div class="detail-field with-info">
                    ...
                    ${t.coil_dry_mode===`dry`?h`<rs-info-icon
                          icon="mdi:alert-outline"
                          .text=${C(`coil_dry.mode_dry_warning`,c)}
                        ></rs-info-icon>`:g}
                  </div>
                  ...
                  <div class="detail-field">
                    ...
                    >
                      ...
                      >
                      <ha-list-item value="__keep__"
                        >${C(`devices.coil_dry_fan_mode_keep`,c)}</ha-list-item
                      >
                      ${(i?.attributes?.fan_modes??[]).map(e=>h`<ha-list-item value="${e}">${e}</ha-list-item>`)}
                    </ha-select>
                  </div>
      ...
      ${this.selectedTempSensor?h`
            <div class="detail-field with-info">
              <ha-select
                ...
                .options=${[{value:`proportional`,label:C(`devices.setpoint_mode_proportional`,c)},{value:`direct`,label:C(`devices.setpoint_mode_direct`,c)},{value:`follow`,label:C(`devices.setpoint_mode_follow`,c)}]}
              ...
              >
                ...
                <ha-list-item value="follow"
                  >${C(`devices.setpoint_mode_follow`,c)}</ha-list-item
                >
              </ha-select>
  ...
  `}get _allPersons(){let e=this.selectedPresencePersons.filter(e=>!this.presencePersons.includes(e));return[...this.presencePersons,...e]}_isMissing(e){return!this.hass.states[e]}render(){return!this.presenceEnabled||!this.editing&&this._allPersons.length===0?g:this.editing?h`
    ...
    `}_onInput(e){let t=parseFloat(e.target.value);isNaN(t)||this.dispatchEvent(new CustomEvent(`value-changed`,{detail:t,bubbles:!0,composed:!0}))}};j([b({type:String})],Jt.prototype,`label`,void 0),j([b({type:String})],Jt.prototype,`suffix`,void 0),j([b({type:Number})],Jt.prototype,`value`,void 0),j([b({type:Number})],Jt.prototype,`min`,void 0),j([b({type:Number})],Jt.prototype,`max`,void 0),j([b({type:Number})],Jt.prototype,`step`,void 0),j([b({type:String})],Jt.prototype,`hint`,void 0),Jt=j([y(`rs-threshold-field`)],Jt),v(),S(),M();var Yt=class extends It{constructor(...e){super(...e),this.schedules=[]}static{this.styles=[It.sharedStyles,R,l`
      .pos-badge {
        font-size: 0.8em;
        padding: 1px 6px;
        border-radius: 10px;
    ...
    `}_onSwitchChange(e){this._emit(`heat_source_orchestration`,e.target.checked)}_onNumberInput(e,t){let n=parseFloat(t.target.value);isNaN(n)||this._emit(e,n)}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],Zt.prototype,`hass`,void 0),j([b({type:Boolean})],Zt.prototype,`enabled`,void 0),j([b({type:Number})],Zt.prototype,`primaryDelta`,void 0),j([b({type:Number})],Zt.prototype,`outdoorThreshold`,void 0),j([b({type:Number})],Zt.prototype,`acMinOutdoor`,void 0),j([b({type:Boolean})],Zt.prototype,`editing`,void 0),Zt=j([y(`rs-heat-source-section`)],Zt),v(),S(),M();var Qt=class extends _{constructor(...e){super(...e),this.icon=``,this.label=``,this.hint=``,this.checked=!1,this.disabled=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return h`
    ...
    `}_updateGroup(e,t,n){let r=[...this.compressorGroups];r[e]={...r[e],[t]:n},this._fire(r)}_addGroup(){this._fire([...this.compressorGroups,{id:self.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,name:``,members:[],min_run_minutes:15,min_off_minutes:5,master_entity:``,conflict_resolution:`heating_priority`,action_script:``,enforce_uniform_mode:!1}])}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`compressorGroups`,value:e},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],bn.prototype,`hass`,void 0),j([b({type:Array})],bn.prototype,`compressorGroups`,void 0),bn=j([y(`rs-settings-compressor`)],bn),v(),S(),M();var xn=`__keep__`,J=class extends q{constructor(...e){super(...e),this.coilDryEnabled=!1,this.coilDryMinutes=20,this.coilDryMode=`fan_only`,this.coilDryFanMode=`low`,this.coilDryMinCoolingMinutes=10,this.coilDryDrainMinutes=0,this.availableFanModes=[]}_numberField(e,t,n,r,i,a,o){let s=this.hass.language;return h`
      <div class="threshold-field">
        <ha-textfield
          ...
          min="${a}"
          max="${o}"
          @change=${t=>{let n=parseInt(t.target.value,10);!isNaN(n)&&n>=a&&n<=o&&this._fire(e,n)}}
        ></ha-textfield>
        <span class="field-hint">${C(i,s)}</span>
      </div>
    `}render(){let e=this.hass.language,t=this.availableFanModes.length?this.availableFanModes:[`low`,`medium`,`high`];return h`
      <div class="toggle-row">
        <div class="toggle-text">
          <span class="toggle-label">${C(`coil_dry.title`,e)}</span>
          <span class="toggle-hint">${C(`coil_dry.hint`,e)}</span>
        </div>
        <ha-switch
          .checked=${this.coilDryEnabled}
          @change=${e=>this._fire(`coilDryEnabled`,e.target.checked)}
        ></ha-switch>
      </div>

      ${this.coilDryEnabled?h`
            <div class="threshold-grid" style="margin-top: 12px">
              ${this._numberField(`coilDryMinutes`,this.coilDryMinutes,`coil_dry.duration_label`,`coil_dry.duration_suffix`,`coil_dry.duration_hint`,1,60)}
              ${this._numberField(`coilDryMinCoolingMinutes`,this.coilDryMinCoolingMinutes,`coil_dry.min_cooling_label`,`coil_dry.min_cooling_suffix`,`coil_dry.min_cooling_hint`,1,240)}
              ${this._numberField(`coilDryDrainMinutes`,this.coilDryDrainMinutes,`coil_dry.drain_label`,`coil_dry.drain_suffix`,`coil_dry.drain_hint`,0,15)}
            </div>
            ...
            <div class="threshold-grid" style="margin-top: 12px">
              <div class="threshold-field">
                <ha-select
                  ...
                  .value=${this.coilDryFanMode===``?xn:this.coilDryFanMode}
                  .options=${[{value:xn,label:C(`coil_dry.fan_mode_keep`,e)},...t.map(e=>({value:e,label:e}))]}
                  @selected=${e=>{let t=I(e),n=this.coilDryFanMode===``?xn:this.coilDryFanMode;t&&t!==n&&this._fire(`coilDryFanMode`,t===xn?``:t)}}
                  @closed=${e=>e.stopPropagation()}
                  fixedMenuPosition
                >
                  <ha-list-item value="${xn}"
                    >${C(`coil_dry.fan_mode_keep`,e)}</ha-list-item
                  >
                  ${t.map(e=>h`<ha-list-item value="${e}">${e}</ha-list-item>`)}
                </ha-select>
                <span class="field-hint">${C(`coil_dry.fan_mode_hint`,e)}</span>
              </div>
              ...
              <div class="threshold-field">
                ...
                >
                  <ha-list-item value="fan_only"
                    >${C(`coil_dry.mode_fan_only`,e)}</ha-list-item
                  >
                  <ha-list-item value="dry">${C(`coil_dry.mode_dry`,e)}</ha-list-item>
                </ha-select>
                ${this.coilDryMode===`dry`?h`<span class="field-hint warning"
                      >${C(`coil_dry.mode_dry_warning`,e)}</span
                    >`:g}
              </div>
            </div>
          `:g}
    ...
    `}static{this.styles=[q.settingsBaseStyles]}};j([b({attribute:!1})],Sn.prototype,`hass`,void 0),j([b({type:Boolean})],Sn.prototype,`moldDetectionEnabled`,void 0),j([b({type:Number})],Sn.prototype,`moldHumidityThreshold`,void 0),j([b({type:Number})],Sn.prototype,`moldSustainedMinutes`,void 0),j([b({type:Boolean})],Sn.prototype,`moldPreventionEnabled`,void 0),j([b({type:String})],Sn.prototype,`moldPreventionIntensity`,void 0),Sn=j([y(`rs-settings-mold`)],Sn),v(),S(),M();var Cn=class extends q{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};j([b({attribute:!1})],Cn.prototype,`hass`,void 0),j([b({type:Boolean})],Cn.prototype,`notificationsEnabled`,void 0),j([b({type:Array})],Cn.prototype,`notificationTargets`,void 0),j([b({type:Number})],Cn.prototype,`notificationCooldown`,void 0),j([b({type:Boolean})],Cn.prototype,`moldPreventionEnabled`,void 0),j([b({type:Boolean})],Cn.prototype,`moldPreventionNotify`,void 0),Cn=j([y(`rs-settings-notifications`)],Cn),v(),S(),M();var wn=250,Tn=class extends q{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return h`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<wn}async _boostLearning(e){try{L(this,`saving`);let t=await this.hass.callWS({type:`roommind/model/boost_learning`,area_id:e});L(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{L(this,`error`)}}static{this.styles=[q.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};j([b({attribute:!1})],Tn.prototype,`hass`,void 0),j([b({attribute:!1})],Tn.prototype,`rooms`,void 0),j([b({type:Array})],Tn.prototype,`learningDisabledRooms`,void 0),j([b({attribute:!1})],Tn.prototype,`boostAppliedAt`,void 0),j([b({attribute:!1})],Tn.prototype,`roomsLive`,void 0),j([x()],Tn.prototype,`_showLearningExceptions`,void 0),j([x()],Tn.prototype,`_boostSelectedRoom`,void 0),Tn=j([y(`rs-settings-learning`)],Tn),v(),S(),M();var En=class extends q{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return h`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `]}};j([b({attribute:!1})],En.prototype,`hass`,void 0),j([b({attribute:!1})],En.prototype,`rooms`,void 0),j([x()],En.prototype,`_resetSelectedRoom`,void 0),En=j([y(`rs-settings-reset`)],En),v(),S(),M();var Y=class extends _{constructor(...e){super(...e),this.rooms={},this._groupByFloor=!1,this._climateControlActive=!0,this._learningDisabledRooms=[],this._outdoorTempSensor=``,this._outdoorHumiditySensor=``,this._outdoorCoolingMin=16,this._outdoorHeatingMax=22,this._controlMode=`mpc`,this._comfortWeight=70,this._weatherEntity=``,this._outdoorUnavailableNotify=!0,this._predictionEnabled=!0,this._vacationActive=!1,this._vacationTemp=15,this._vacationUntil=``,this._presenceEnabled=!1,this._presencePersons=[],this._presenceAwayAction=`eco`,this._presenceClearsOverride=!1,this._scheduleOffAction=`eco`,this._valveProtectionEnabled=!1,this._valveProtectionInterval=7,this._moldDetectionEnabled=!1,this._moldHumidityThreshold=70,this._moldSustainedMinutes=30,this._moldNotificationCooldown=60,this._moldNotificationsEnabled=!0,this._moldNotificationTargets=[],this._moldPreventionEnabled=!1,this._moldPreventionIntensity=`medium`,this._moldPreventionNotify=!1,this._compressorGroups=[],this._coilDryEnabled=!1,this._coilDryMinutes=20,this._coilDryMode=`fan_only`,this._coilDryFanMode=`low`,this._coilDryMinCoolingMinutes=10,this._coilDryDrainMinutes=0,this._boostAppliedAt={},this._loaded=!1}connectedCallback(){super.connectedCallback(),this._loadSettings()}disconnectedCallback(){super.disconnectedCallback(),this._saveDebounce&&clearTimeout(this._saveDebounce)}async _loadSettings(){try{let e=(await this.hass.callWS({type:`roommind/settings/get`})).settings;this._groupByFloor=e.group_by_floor??!1,this._climateControlActive=e.climate_control_active??!0,this._learningDisabledRooms=e.learning_disabled_rooms??[],this._outdoorTempSensor=e.outdoor_temp_sensor??``,this._outdoorHumiditySensor=e.outdoor_humidity_sensor??``,this._outdoorCoolingMin=e.outdoor_cooling_min??16,this._outdoorHeatingMax=e.outdoor_heating_max??22,this._controlMode=e.control_mode??`mpc`,this._comfortWeight=e.comfort_weight??70,this._weatherEntity=e.weather_entity??``,this._outdoorUnavailableNotify=e.outdoor_unavailable_notify??!0,this._predictionEnabled=e.prediction_enabled??!0;let t=e.vacation_until;this._vacationActive=!!(t&&t>Date.now()/1e3),this._vacationTemp=e.vacation_temp??15,this._vacationUntil=t&&t>Date.now()/1e3&&t<3250368e4?this._tsToDatetimeLocal(t):``,this._presenceEnabled=e.presence_enabled??!1,this._presencePersons=e.presence_persons??[],this._presenceAwayAction=e.presence_away_action??`eco`,this._presenceClearsOverride=e.presence_clears_override??!1,this._scheduleOffAction=e.schedule_off_action??`eco`,this._valveProtectionEnabled=e.valve_protection_enabled??!1,this._valveProtectionInterval=e.valve_protection_interval_days??7,this._moldDetectionEnabled=e.mold_detection_enabled??!1,this._moldHumidityThreshold=e.mold_humidity_threshold??70,this._moldSustainedMinutes=e.mold_sustained_minutes??30,this._moldNotificationCooldown=e.mold_notification_cooldown??60,this._moldNotificationsEnabled=e.mold_notifications_enabled??!0,this._moldNotificationTargets=e.mold_notification_targets??[],this._moldPreventionEnabled=e.mold_prevention_enabled??!1,this._moldPreventionIntensity=e.mold_prevention_intensity??`medium`,this._moldPreventionNotify=e.mold_prevention_notify_enabled??!1,this._compressorGroups=e.compressor_groups??[],this._coilDryEnabled=e.coil_dry_enabled??!1,this._coilDryMinutes=e.coil_dry_minutes??20,this._coilDryMode=e.coil_dry_mode??`fan_only`,this._coilDryFanMode=e.coil_dry_fan_mode??`low`,this._coilDryMinCoolingMinutes=e.coil_dry_min_cooling_minutes??10,this._coilDryDrainMinutes=e.coil_dry_drain_minutes??0,this._boostAppliedAt=e.boost_applied_at??{}}catch(e){console.debug(`[RoomMind] loadSettings:`,e)}finally{this._loaded=!0}}render(){if(!this._loaded)return h`<div class="loading">${C(`panel.loading`,this.hass.language)}</div>`;let e=this.hass.language;return h`
      ...
      <rs-settings-panel .heading=${C(`coil_dry.title`,e)} icon="mdi:air-filter">
...
`)}function On(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function kn(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function An(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{jn(e)}),!0):jn(e)}function jn(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}v(),S(),M();var X=class extends _{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return h`
    ...
    `}_onRoomSelected(e){let t=I(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=Dn(this.data);e&&(On(e,kn(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});On(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=Dn(this.data);e&&(An(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});An(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[R,l`
      :host {
        display: block;
      }
    ...
    `]}};j([b({attribute:!1})],X.prototype,`hass`,void 0),j([b({attribute:!1})],X.prototype,`rooms`,void 0),j([b({type:String})],X.prototype,`selectedRoom`,void 0),j([b({type:Number})],X.prototype,`rangeStart`,void 0),j([b({type:Number})],X.prototype,`rangeEnd`,void 0),j([b({type:String})],X.prototype,`activeQuick`,void 0),j([b({attribute:!1})],X.prototype,`data`,void 0),j([b({type:String})],X.prototype,`language`,void 0),j([x()],X.prototype,`_openDropdown`,void 0),j([x()],X.prototype,`_diagLoading`,void 0),X=j([y(`rs-analytics-toolbar`)],X),v();var Mn=l`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`,Nn=108e5;function Pn(e,t){let{hass:n,language:r,chartAnchor:i,forecast:a,isOutdoor:o}=t,s=e=>T(e,n),c=[],l=[],u=[],d=[],ee=[];for(let t of e){let e=t.ts*1e3;t.room_temp!==null&&c.push([e,s(t.room_temp)]),!o&&t.target_temp!==null&&l.push([e,s(t.target_temp)]),!o&&t.predicted_temp!==null&&u.push([e,s(t.predicted_temp)]),t.outdoor_temp!==null&&d.push([e,s(t.outdoor_temp)]),!o&&t.device_setpoint!=null&&ee.push([e,s(t.device_setpoint)])}for(let e of a??[]){let t=e.ts*1e3;!o&&e.target_temp!==null&&l.push([t,s(e.target_temp)]),!o&&e.predicted_temp!==null&&u.push([t,s(e.predicted_temp)])}let f=[{id:`room_temp`,type:`line`,name:C(`analytics.temperature`,r),color:`rgb(255, 152, 0)`,data:c,showSymbol:!1,smooth:!0,lineStyle:{width:2},yAxisIndex:0}];o||f.push({id:`target_temp`,type:`line`,name:C(`analytics.target`,r),color:`rgb(76, 175, 80)`,data:l,showSymbol:!1,smooth:!1,lineStyle:{width:2,type:`dashed`},yAxisIndex:0}),u.length>0&&f.push({id:`predicted_temp`,type:`line`,name:C(`analytics.prediction`,r),color:`rgb(33, 150, 243)`,data:u,showSymbol:!1,smooth:!0,lineStyle:{width:2,type:`dotted`},yAxisIndex:0}),ee.length>0&&f.push({id:`device_target`,type:`line`,name:`TRV / AC`,color:`rgb(156, 39, 176)`,data:ee,showSymbol:!1,smooth:!1,step:`end`,lineStyle:{width:1,type:`dashed`},yAxisIndex:0}),d.length>0&&f.push({id:`outdoor_temp`,type:`line`,name:C(`analytics.outdoor`,r),color:`rgb(158, 158, 158)`,data:d,showSymbol:!1,smooth:!0,lineStyle:{width:1},yAxisIndex:0});let te=[],ne=[],re=[],ie=!1,ae=!1,oe=!1;for(let t of e){let e=t.ts*1e3;t.mode===`heating`?(te.push([e,999]),ie=!0):te.push([e,null]),t.mode===`cooling`?(ne.push([e,999]),ae=!0):ne.push([e,null]),t.window_open?(re.push([e,999]),oe=!0):re.push([e,null])}return ie&&f.push({id:`heating_events`,type:`line`,name:C(`analytics.heating_period`,r),color:`rgb(244, 67, 54)`,data:te,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(244, 67, 54, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),ae&&f.push({id:`cooling_events`,type:`line`,name:C(`analytics.cooling_period`,r),color:`rgb(63, 81, 181)`,data:ne,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(63, 81, 181, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),oe&&f.push({id:`window_events`,type:`line`,name:C(`analytics.window_open_period`,r),color:`rgb(0, 150, 136)`,data:re,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(0, 150, 136, 0.1)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),f.push({id:`now_marker`,type:`line`,name:``,color:`rgba(255,255,255,0.3)`,data:[[i,-999],[i,999]],showSymbol:!1,lineStyle:{width:1,type:`dashed`},yAxisIndex:0,tooltip:{show:!1},z:-2}),f}function Fn(e,t,n){let{hass:r,language:i,chartAnchor:a,rangeStart:o,rangeEnd:s}=n,c=w(r),l={type:`value`,name:c};if(e.length>0){let t=1/0,n=-1/0;for(let r of e)r<t&&(t=r),r>n&&(n=r);let r=n-t,i=Math.max(r*.1,.5);l.min=Math.floor((t-i)*2)/2,l.max=Math.ceil((n+i)*2)/2}return{xAxis:{type:`time`,min:o,max:Math.abs(s-Date.now())<36e5?a+Nn:s},yAxis:l,dataZoom:[{type:`inside`,xAxisIndex:0,filterMode:`none`}],tooltip:{trigger:`axis`,axisPointer:{snap:!1},valueFormatter:e=>e.toFixed(1)+`\xA0`+c,formatter:e=>{if(!Array.isArray(e)||e.length===0)return``;let n=`<div style="font-weight:500;margin-bottom:4px">${new Date(e[0].value[0]).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}</div>`,a=null,o=null;for(let t of e){if(t.seriesId?.endsWith(`_events`))continue;let e=t.value?.[1];e!=null&&(n+=`<div>${t.color?`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.color};margin-right:6px"></span>`:``}${t.seriesName}: ${e.toFixed(1)}\u00A0${c}</div>`,t.seriesId===`room_temp`&&(a=e),t.seriesId===`predicted_temp`&&(o=e))}if(a!==null&&o!==null){let e=a-o;n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px">Delta: ${e>=0?`+`:``}${e.toFixed(2)}\u00A0${c}</div>`}if(t.length>0){let a=e[0].value[0]/1e3,o=null,s=1/0;for(let e of t){let t=Math.abs(e.ts-a);t<s&&(s=t,o=e)}if(o){let e=[];if(o.mode===`heating`){let t=o.heating_power;t!=null&&t>0&&t<100?e.push(`${C(`analytics.heating_period`,i)} ${t}%`):e.push(C(`analytics.heating_period`,i)),o.device_setpoint!=null&&e.push(`TRV ${O(o.device_setpoint,r)}\u00A0${c}`)}else o.mode===`cooling`&&(e.push(C(`analytics.cooling_period`,i)),o.device_setpoint!=null&&e.push(`AC ${O(o.device_setpoint,r)}\u00A0${c}`));o.window_open&&e.push(C(`analytics.window_open_period`,i)),e.length>0&&(n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px;color:rgba(255,255,255,0.7)">${e.join(` · `)}</div>`),o.blind_position!=null&&(n+=`<div style="color:rgba(255,255,255,0.7)">${C(`analytics.blind_position`,i)} ${100-o.blind_position}%</div>`)}}let s=document.createElement(`div`);return s.innerHTML=n,s}},grid:{top:15,left:10,right:10,bottom:5,containLabel:!0}}}v(),S(),M();var Z=class extends _{constructor(...e){super(...e),this.data=null,this.rangeStart=0,this.rangeEnd=0,this.chartAnchor=0,this.language=`en`,this.isOutdoor=!1,this._hiddenSeries=new Set([`outdoor_temp`,`device_target`]),this._chartInfoExpanded=!1}render(){let e=this.language,t=this.data?[...this.data.history,...this.data.detail]:[],n=[...t,...this.data?.forecast??[]],r={hass:this.hass,language:e,chartAnchor:this.chartAnchor,rangeStart:this.rangeStart,rangeEnd:this.rangeEnd,forecast:this.data?.forecast,isOutdoor:this.isOutdoor},i=t.length>0?Pn(t,r):[],a=[],o=i.map(e=>{let t=e.id,n=e.lineStyle||{},r=t.endsWith(`_events`);if(this._hiddenSeries.has(t)){let t={...e,lineStyle:{...n,width:0,opacity:0}};return e.areaStyle&&(t.areaStyle={...e.areaStyle,opacity:0}),t}if(!r&&t!==`now_marker`)for(let t of e.data)t&&t[1]!=null&&a.push(t[1]);let i={...e,lineStyle:{...n,opacity:1}};return e.areaStyle&&(i.areaStyle={...e.areaStyle,opacity:1}),i}),s=Fn(a,n,r);return h`
      <ha-card>
        <div class="card-header">
...
`).map(e=>h`<p>
        ...
        </p>`)}_toggleSeries(e){let t=new Set(this._hiddenSeries);t.has(e)?t.delete(e):t.add(e),this._hiddenSeries=t}static{this.styles=[Mn,l`
      :host {
        display: block;
      }
    ...
    `}_toggleStat(e){this._expandedStat=this._expandedStat===e?null:e}static{this.styles=[Mn,l`
      :host {
        display: block;
      }
    ...
    `]}};j([b({attribute:!1})],In.prototype,`hass`,void 0),j([b({attribute:!1})],In.prototype,`data`,void 0),j([b({type:String})],In.prototype,`language`,void 0),j([x()],In.prototype,`_expandedStat`,void 0),In=j([y(`rs-analytics-model`)],In),v(),S(),M();var Q=class extends _{constructor(...e){super(...e),this.rooms={},this.initialRoom=``,this.controlMode=`bangbang`,this._selectedRoom=``,this._rangeStart=new Date(new Date().setHours(0,0,0,0)).getTime(),this._rangeEnd=Date.now(),this._data=null,this._chartAnchor=Date.now(),this._loading=!1,this._activeQuick=`24h`}connectedCallback(){super.connectedCallback(),this._refreshInterval=setInterval(()=>this._silentRefresh(),6e4)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0)}willUpdate(e){e.has(`initialRoom`)&&this.initialRoom&&(this._selectedRoom=this.initialRoom);let t=!1;if(e.has(`rooms`)&&!this._selectedRoom){let e=Object.keys(this.rooms);e.length>0&&(this._selectedRoom=e[0],t=!0,this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:e[0]},bubbles:!0,composed:!0})))}(t||e.has(`_selectedRoom`)||e.has(`_rangeStart`)||e.has(`_rangeEnd`))&&this._selectedRoom&&this._fetchData()}render(){let e=this.hass.language;return h`
  ...
  `}connectedCallback(){super.connectedCallback(),ln().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return h``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:C(`panel.tab.rooms`,e),analytics:C(`tabs.analytics`,e),settings:C(`panel.tab.settings`,e)};return h`
      <div class="toolbar">
        ...
        ${t&&this._rooms[this._selectedAreaId]?h`<ha-icon-button
              ...
              ></ha-icon-button
              ><ha-icon-button .path=${Rn} @click=${this._onDeleteRoom}></ha-icon-button>`:g}
